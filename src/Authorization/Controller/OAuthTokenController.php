...
class OAuthTokenController extends TokenController
{
     ...
     *         name="refresh_token",
     *         in="formData",
     *         description="The authorization code received by the authorization server(for `refresh_token` grant
     *         type`", required=false, type="string"
     *     ),
     *     @SWG\Parameter(
     *         name="code",
     *         in="formData",
     *         description="The authorization code received by the authorization server (For `authorization_code` grant
     *         type)", required=false, type="string"
     *     ),
     *     @SWG\Parameter(
     *         name="scope",
     *         in="formData",
     *         description="If the `redirect_uri` parameter was included in the authorization request, and their values
     *         MUST be identical", required=false, type="string"
     *     ),
     *     @SWG\Parameter(
     *         name="redirect_uri",
     *         in="formData",
     ...
     *
     */
    public function tokenAction(Request $request): TokenInterface
    {
